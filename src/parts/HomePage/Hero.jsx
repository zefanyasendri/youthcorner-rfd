        ...
        <React.Fragment>
            <section className="flex items-center hero">
                <div className="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
                    ...
                    Unleash Your Style,  <br className="" />Create Your Space
                    </h1>
                    <h2 className="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
                    Where style meets comfort,
                    <br className="hidden lg:block" /> creating your Corner of Youthful bliss
                    </h2>
                    <div>
                    <a
                        href="#browse-the-room"
                        className="bg-blue-400 text-black hover:bg-black hover:text-blue-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200"
                        >Explore Now</a>
                    </div>
                </div>
