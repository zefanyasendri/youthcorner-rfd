...
export default function ShippingDetails() {
    ...
    //agar button submit tidak bisa di klik jika ada input yang kosong
    ...
    async function fnSubmit(event) {
        event.preventDefault() //agar saat enter/submit, tidak akan kirim dan simpen ke halaman itu lagi
        try {
                            ...
                            <div className="flex -mx-2 flex-wrap">
                                {
                                    ...
                                    : data?.couriers?.map(item => 
                                        <div key={item} className="px-2 w-6/12 h-24 mb-4">
                                            <button
                                                type="button"
                                                onClick={
                                                    () => fnUpdateState({
